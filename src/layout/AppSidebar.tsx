...
const navItems: NavItem[] = [
  ...
  },
  {
    icon: <UserIcon />,
    name: "Subscribers",
    path: "/owners/subscribers",
    roles: ["owner"],
  },
  {
    icon: <TableIcon />,
    name: "Reporting",
    path: "/owners/reporting",
    roles: ["owner"],
  },
];
...
const AppSidebar: React.FC = () => {
  ...
  const [currentRole, setCurrentRole] = useState("subscriber");
  ...
  const filterMenuByRole = (menu: NavItem[]) => {
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            <div>
              ...
              {renderMenuItems(filterMenuByRole(navItems), "main")}
            </div>
          </div>
        </nav>
      </div>
